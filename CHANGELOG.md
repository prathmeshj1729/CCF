...
- Added vTPM attestation support (`vtpm_v1` quote format) rooted in AMD SEV-SNP hardware, enabling independent TPM2 quote verification for Google Confidential Spaces and Azure Confidential VMs (#7786).
